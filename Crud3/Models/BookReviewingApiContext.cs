...
public partial class BookReviewingApiContext : DbContext
{
    public BookReviewingApiContext()
    {
    }

    public BookReviewingApiContext(DbContextOptions<BookReviewingApiContext> options)
        : base(options)
    {
    }
